//# sourceURL=d3PhenotypeHeatmap.js

'use strict';

window.smartRApp.directive('phenotypeHeatmapPlot', [
    'smartRUtils',
    '$rootScope',
    function(smartRUtils, $rootScope) {
        ...
        return {
            ...
            templateUrl: $rootScope.smartRPath +  '/js/smartR/_angular/templates/phenotypeHeatmap.html',
